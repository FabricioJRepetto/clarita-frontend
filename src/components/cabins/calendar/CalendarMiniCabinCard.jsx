...
const CalendarMiniCabinCard = ({ data, date, cb }) => {
    ...
    return (
        <div onClick={selectCabin} className='flex items-center justify-around px-2 w-full rounded-md bg-slate-200 dark:bg-slate-800 cursor-pointer hover:dark:bg-slate-700'>
            <b>{data?.identifier}</b>
...
export default CalendarMiniCabinCard