...
const Profile = () => {
    ...
    const reserv_neto = (reservs) => {
        ...
        const correct_value = (e) => {
            let aux = 0
            if (e.total && e.currency === 'ARS') return e.total
            if (e.currency === 'ARS') aux += e.amount
                    ...
                    <section className='details-card mt-2 text-base'>
                        <section >
                            ...
                            <div className='details-data'>
                                ...
                                <p>{stats.reserv_neto} <i className='text-gray-500 text-sm'>ARS</i></p>
                                <p>(Solo se toman en cuenta cobros en ARS)</p>
                            </div>
                        </section>
                    </section>
