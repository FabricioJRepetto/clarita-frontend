...
const Navbar = () => {
    ...
    useEffect(() => {
        console.log('navbar theme starter');
    ...
    return (
        <header className={`w-screen h-16 px-8 py-4 fixed top-0 left-0 flex justify-between items-center backdrop-blur-lg backdrop-grayscale text-black dark:text-white bg-orange-50/90 dark:bg-slate-900/75`}>
